...
const Footer = () => {
    return(
        <div className="bg-zinc-600 text-white w-full h-60 flex justify-evenly items-center text-left ">
            <div>
                ...
                <div className="flex space-x-4 mt-4">
                    ...
                    <a href="https://github.com" target="_blank" rel="noopener">
                        <img src="./src/assets/img/Github.png" alt="logo github .png" className="w-5 h-5 opacity-50 hover:opacity-100"/>
                    </a>
                    <a href="https://x.com/" target="_blank" rel="noopener">
                        <img src="./src//assets/img/twitterx.png" alt="logo x anciennement tweeter .png" className="w-5 h-5 opacity-50 hover:opacity-100"/>
                    </a>
                    <a href="https://fr.linkedin.com/" target="_blank" rel="noopener">
                        <img src="./src/assets/img/linkendin.png" alt="logo linkendin .png"  className="w-5 h-5 opacity-50 hover:opacity-100"/>
                    </a>
                </div>
            </div>
            <div className="w-48">
            ...
            <div className="w-60">
                <h3 className='mb-4 text-xl'>Mes dernières réalisations</h3>
                <ul>
                    <li className={styleLink()}>
